...
- "Analista de Segurança da Informação | MultiCloud | Segurança Ofensiva | AZ-900 | CC | 🕷️ 32x CVEs Publicados"
...
const aboutMe = {
    ...
    experience: [
        {
            ...
            responsibilities: [
                ...
                "Gerenciamento de acessos via IAM",
                "Automação de regras de firewall e exceções de roles com Terraform (IaC)",
                "Criação de playbooks no SIEM para tratamento de vulnerabilidades"
            ]
        },
        {
            role: "Residente Tecnológica – Red Team",
            organization: "RNP",
            responsibilities: [
                "Pentests em aplicações web e infraestrutura",
                "Elaboração de relatórios técnicos com recomendações de remediação",
    ...
    certifications: ["AZ-900", "CC"],
    
    projects: [
        {
            name: "CVE Hunters",
            role: "Voluntária",
            description: "Contribuição para a segurança de plataformas Open Source"
        }
    ]
};
